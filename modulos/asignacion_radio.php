...
extract($_REQUEST);
    ...
    if(isset($cedula))
    {
        ...
        {
            $_SESSION['menssage'] = "La persona ya posee el radio asignado.";
            header("Location:asignacion_radio.php?id=".$id_radio);
            die();
        }
        ...
        {
            $_SESSION['menssage'] = "No existe una persona registrada en el sistema identificada con la cédula ".$cedula;
            header("Location:asignacion_radio.php?id=".$id_radio);
            die();
        }
        else
        {
            $persona = mysql_fetch_assoc($verificar_persona);
...
<head>
    ...
    window.addEventListener("load",function(){
        asignacion.addEventListener("submit",function(event){
            if(nombre.value == "")
            {
                alert('Debes consultar la cédula a asignar.');
                cedula.focus();
            ...
            <article class="col-sm-9 maincontent">
                <header class="page-header">
                    ...
                    <form method="POST" action="">
                        <input type="hidden" name="id_radio" value="<?=$id?>">
                        <div class="row">
                            <div class="col-sm-4">
                                <span>Cédula</span>
                                <input class="form-control" type="text" id="cedula" value="<?=$cedula?>" name="cedula" placeholder="Cédula">
                            </div>
                            <div class="col-sm-4">
                                <br>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <span>Nombre</span>
                                <input class="form-control" type="text" value="<?=$nombre?>" id="nombre" name="nombre" placeholder="Nombre" disabled>
                            </div>
                            <div class="col-sm-4">
                                <span>Apellido</span>
                                <input class="form-control" type="text" value="<?=$apellido?>" name="apellido" placeholder="Apellido" disabled>
                            </div>
                            <div class="col-sm-4">
                                <span>Sexo</span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <span>Teléfono</span>
                                <input class="form-control" type="text" value="<?=$telefono?>" name="telefono" placeholder="Teléfono" disabled>
                            </div>
                            <div class="col-sm-4">
                                <span>Unidad</span>
                            ...
                            <div class="col-sm-4">
                                <span>Jerarquía</span>
                                <select class="form-control" name="jerarquia" disabled>
                                    <option value="">- Seleccione -</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <span>Promoción</span>
                                <select class="form-control" name="promocion" disabled>
                                    <option value="">- Seleccione -</option>
                        ...
                        <br>
                    <form name="asignacion" action="../procesos/asignacion_radio.php" method="POST">
                        <input type="hidden" name="id_radio" value="<?=$id?>">
                        <?php if(isset($cedula)){ ?>
                        <input type="hidden" name="cedula_asignacion" value="<?=$cedula?>">
                        <?php } ?>
                        <div class="row">
                            <div class="col-sm-4">
                                <span>Ubicación de la asignación</span>
                                <input type="text" name="ubicacion_ultima_asignacion" class="form-control" required>
                            </div>
                            <div class="col-sm-2">
                            ...
                            <div class="col-sm-6 text-right">
                                <br>
                                <input class="btn btn-action" name="aceptar" type="submit" value="Asignar">
                            </div>
                        </div>
                    </form>
